Ce parcours a constitué une première étape d’approfondissement en **modélisation statistique** et en **machine learning**, avant mon orientation vers les **systèmes d’information** et la **Business Intelligence**.  
